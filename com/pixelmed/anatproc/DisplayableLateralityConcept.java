...
public class DisplayableLateralityConcept extends DisplayableConcept {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/anatproc/DisplayableLateralityConcept.java,v 1.15 2026/05/17 08:42:43 dclunie Exp $";
	...
	public DisplayableLateralityConcept(String conceptUniqueIdentifier,String conceptIdentifier,
			String codingSchemeDesignator,String legacyCodingSchemeDesignator,String[] otherLegacyCodingSchemeDesignators,String codingSchemeVersion,String codeValue,String legacyCodeValue,String codeMeaning,String codeStringEquivalent,String[] synonynms,
			String[] shortcutMenuEntry,String[] fullyQualifiedMenuEntry
			) {
		super(conceptUniqueIdentifier,conceptIdentifier,codingSchemeDesignator,legacyCodingSchemeDesignator,otherLegacyCodingSchemeDesignators,codingSchemeVersion,codeValue,legacyCodeValue,codeMeaning,codeStringEquivalent,synonynms,shortcutMenuEntry,fullyQualifiedMenuEntry);
	}
